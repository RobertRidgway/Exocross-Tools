...
def InpWrite(speciesInfo,temperature,pressure,npoints,range_,offset=25, peturbers=None,homedir=os.getcwd()):
    ...
    if homedir[-1] != '/':
        homedir=homedir+'/'
    filename=homedir+'{0}_{1}_{2}_{3}_{4}.inp'.format(speciesInfo.molecule,temperature,pressure,range_[0],range_[1])
    #print(filename)
...
if __name__ == '__main__':
    ...
    InpWrite(H2O,1600,10.0,412001,range_,peturbers=listpeturbers)
